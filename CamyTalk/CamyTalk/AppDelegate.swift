...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // initialize MCFManager
        let mpcManager = MCFManager()
        mpcManager.managedContext = coreDataStack.getCoreDataContext()
...
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.camy.CamyTalk" in the application's documents Application Support directory.
